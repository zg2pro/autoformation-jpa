...
public class GUIBox extends javax.swing.JDialog {

    public GUIBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = Application.getInstance(GUILauncher.class).getContext().getResourceMap(GUIBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = Application.getInstance(GUILauncher.class).getContext().getActionMap(GUIBox.class, this);
